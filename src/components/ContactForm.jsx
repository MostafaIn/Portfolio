...
class ContactForm extends Component {
    ...
    render() {
        const { classes } = this.props,
            { message: { name, email, phone, message }, formErrors } = this.state
        ...
        return (
            <form className={classes.container} method="POST" action="https://formspree.io/mostafa2015se@hotmail.com">
                ...
                <TextField
                    ...
                    fullWidth
                />
                {formErrors.email === false ? <Typography variant="caption" color="error">your email ID is not valid! *</Typography> : null}
                <TextField
                    ...
                    fullWidth
                />
                {formErrors.phone === false ? <Typography variant="caption" color="error">just finnish mobile number valid! *</Typography> : null}
                <TextField
